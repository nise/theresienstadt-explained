...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      name: "news",
      component: () =>
        import(/* webpackChunkName: "history" */ "./views/News.vue"),
    },
    {
      path: "/pages/history",
      name: "history",
    ...
    },*/
    {
      ...
      name: "guide",
      component: () =>
        import(/* webpackChunkName: "guidedvideo" */ "./views/GuidedVideo.vue"),
    },
    {
      path: "/pages/propaganda",
      name: "propaganda",
      component: () =>
        import(/* webpackChunkName: "propaganda" */ "./views/Propaganda.vue"),
    },
  ],
});
