...
export default {
  ...
  mounted: function () {
    ...
    leaflet
      .tileLayer(
        "https://api.mapbox.com/styles/v1/followerofnux/ckkfkh0wz038c17pc28efm6l7/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoiZm9sbG93ZXJvZm51eCIsImEiOiJja2tmaGV6YTkwYnB1MnZud2V6bDVlaWc1In0.gFN0_B9BR5KjzltaD9Sbuw",
        {
          attribution:
