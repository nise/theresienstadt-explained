<template>
  <div class="container">
    ...
    <div v-if="sessionId">
      <p>Die Session wurde erfolgreich erstellt. Sie können nun über folgenden Knopf zur Aufgabenpflege (Schritt 2) springen:</p>
      <br>
    ...
    <div v-else>
      ...
      <p>Bitte geben Sie einen Session-Namen ein. Der Name ist frei wählbar und muss nicht eindeutig sein. Mit einem Klick auf Senden können Sie eine neue Session generieren.</p>
