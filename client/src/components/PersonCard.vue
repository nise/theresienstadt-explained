...
<b-container class="ld xld odd bg-light" style="height:210px; overflow-y:visible; height:auto" :style="{display: (this.hideself ? 'none' : 'block')}">
    <b-row>
        ...
        <b-col>
            ...
            <p class = "text-left ml-3">geboren {{person.birth}} in {{person.birth_place}} <br>
                gestorben {{person.death}}, {{person.death_place}}</p>
            <br>
            <br>
            <b-row class = "ml-3">
    ...
    <b-row style="width:inherit">
        <b-collapse :id="'collapse-'+person.id" class="mt-2" style="width:inherit">
            <br>
            ...
            <b-row>
                <b-col v-for="entries in moviescenes"><img class ="movieshotodd movieshotxld movieshotld"/></b-col>
            </b-row>
            <br>
            <b-button v-b-toggle = "'collapse-'+person.id" class = "mr-4 mb-4" @click="togglebio" size="sm" squared variant="dark"
                style = "background-color:black; height:25px; float:right">Weniger...
            </b-button>
