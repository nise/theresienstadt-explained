...
!(function (a, b) { typeof module === 'object' && typeof module.exports === 'object' ? module.exports = a.document ? b(a, !0) : function (a) { if (!a.document) throw new Error('jQuery requires a window with a document'); return b(a) } : b(a) }(typeof window !== 'undefined' ? window : this, (a, b) => {
  var c = [],
    ...
    selector: '',
    length: 0,
    toArray() { return d.call(this) },
    get(a) { return a != null ? a < 0 ? this[a + this.length] : this[a] : d.call(this) },
    pushStack(a) { const b = m.merge(this.constructor(), a); return b.prevObject = this, b.context = this.context, b },
    each(a, b) { return m.each(this, a, b) },
    map(a) { return this.pushStack(m.map(this, (b, c) => a.call(b, c, b))) },
    slice() { return this.pushStack(d.apply(this, arguments)) },
    ...
    end() { return this.prevObject || this.constructor(null) },
    push: f,
    sort: c.sort,
    splice: c.splice,
    ...
    noop() {},
    isFunction(a) { return m.type(a) === 'function' },
    isArray: Array.isArray || function (a) { return m.type(a) === 'array' },
    isWindow(a) { return a != null && a == a.window },
    isNumeric(a) { return !m.isArray(a) && a - parseFloat(a) + 1 >= 0 },
    isEmptyObject(a) { let b; for (b in a) return !1; return !0 },
    isPlainObject(a) { let b; if (!a || m.type(a) !== 'object' || a.nodeType || m.isWindow(a)) return !1; try { if (a.constructor && !j.call(a, 'constructor') && !j.call(a.constructor.prototype, 'isPrototypeOf')) return !1 } catch (c) { return !1 } if (k.ownLast) for (b in a) return j.call(a, b); for (b in a);return void 0 === b || j.call(a, b) },
    type(a) { return a == null ? `${a}` : typeof a === 'object' || typeof a === 'function' ? h[i.call(a)] || 'object' : typeof a },
    globalEval(b) { b && m.trim(b) && (a.execScript || function (b) { a.eval.call(a, b) })(b) },
    camelCase(a) { return a.replace(o, 'ms-').replace(p, q) },
    ...
    trim(a) { return a == null ? '' : (`${a}`).replace(n, '') },
    makeArray(a, b) { const c = b || []; return a != null && (r(Object(a)) ? m.merge(c, typeof a === 'string' ? [a] : a) : f.call(c, a)), c },
    inArray(a, b, c) { let d; if (b) { if (g) return g.call(b, a, c); for (d = b.length, c = c ? c < 0 ? Math.max(0, d + c) : c : 0; d > c; c++) if (c in b && b[c] === a) return c } return -1 },
    merge(a, b) {
      let c = +b.length,
        d = 0,
    ...
    guid: 1,
    proxy(a, b) { let c, e, f; return typeof b === 'string' && (f = a[b], b = a, a = f), m.isFunction(a) ? (c = d.call(arguments, 2), e = function () { return a.apply(b || this, c.concat(d.call(arguments))) }, e.guid = a.guid = a.guid || m.guid++, e) : void 0 },
    now() { return +new Date() },
    support: k,
  }), m.each('Boolean Number String Function Array Date RegExp Object Error'.split(' '), (a, b) => { h[`[object ${b}]`] = b.toLowerCase() }); function r(a) {
    const b = a.length,
      c = m.type(a); return c === 'function' || m.isWindow(a) ? !1 : a.nodeType === 1 && b ? !0 : c === 'array' || b === 0 || typeof b === 'number' && b > 0 && b - 1 in a
  } const s = (function (a) {
    let b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t,
      u = `sizzle${1 * new Date()}`,
      v = a.document,
      w = 0,
      x = 0,
      ...
      db = function (a, b, c) { const d = `0x${b}` - 65536; return d !== d || c ? b : d < 0 ? String.fromCharCode(d + 65536) : String.fromCharCode(d >> 10 | 55296, 1023 & d | 56320) },
      eb = function () { m() }; try { H.apply(E = I.call(v.childNodes), v.childNodes), E[v.childNodes.length].nodeType } catch (fb) {
      H = {
      ...
      preFilter: {
        ATTR(a) { return a[1] = a[1].replace(cb, db), a[3] = (a[3] || a[4] || a[5] || '').replace(cb, db), a[2] === '~=' && (a[3] = ` ${a[3]} `), a.slice(0, 4) },
        CHILD(a) { return a[1] = a[1].toLowerCase(), a[1].slice(0, 3) === 'nth' ? (a[3] || gb.error(a[0]), a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * (a[3] === 'even' || a[3] === 'odd')), a[5] = +(a[7] + a[8] || a[3] === 'odd')) : a[3] && gb.error(a[0]), a },
        PSEUDO(a) {
          let b,
      ...
      filter: {
        TAG(a) { const b = a.replace(cb, db).toLowerCase(); return a === '*' ? function () { return !0 } : function (a) { return a.nodeName && a.nodeName.toLowerCase() === b } },
        ...
        ATTR(a, b, c) { return function (d) { let e = gb.attr(d, a); return e == null ? b === '!=' : b ? (e += '', b === '=' ? e === c : b === '!=' ? e !== c : b === '^=' ? c && e.indexOf(c) === 0 : b === '*=' ? c && e.indexOf(c) > -1 : b === '$=' ? c && e.slice(-c.length) === c : b === '~=' ? (` ${e.replace(Q, ' ')} `).indexOf(c) > -1 : b === '|=' ? e === c || e.slice(0, c.length + 1) === `${c}-` : !1) : !0 } },
        CHILD(a, b, c, d, e) {
        ...
        PSEUDO(a, b) {
          let c,
            e = d.pseudos[a] || d.setFilters[a.toLowerCase()] || gb.error(`unsupported pseudo: ${a}`); return e[u] ? e(b) : e.length > 1 ? (c = [a, a, '', b], d.setFilters.hasOwnProperty(a.toLowerCase()) ? ib((a, c) => {
            let d,
              f = e(a, b),
      ...
      pseudos: {
        not: ib((a) => {
          const b = [],
            c = [],
            d = h(a.replace(R, '$1')); return d[u] ? ib((a, b, c, e) => {
            let f,
              g = d(a, null, e, []),
              h = a.length; while (h--)(f = g[h]) && (a[h] = !(b[h] = f))
          }) : function (a, e, f) { return b[0] = a, d(b, null, f, c), b[0] = null, !c.pop() }
        }),
        has: ib(a => function (b) { return gb(a, b).length > 0 }),
        contains: ib(a => a = a.replace(cb, db), b => (b.textContent || b.innerText || e(b)).indexOf(a) > -1),
        lang: ib(a => W.test(a || '') || gb.error(`unsupported lang: ${a}`), a = a.replace(cb, db).toLowerCase(), (b) => { let c; do if (c = p ? b.lang : b.getAttribute('xml:lang') || b.getAttribute('lang')) return c = c.toLowerCase(), c === a || c.indexOf(`${a}-`) === 0; while ((b = b.parentNode) && b.nodeType === 1);return !1 }),
        ...
        header(a) { return Z.test(a.nodeName) },
        input(a) { return Y.test(a.nodeName) },
        ...
        even: ob((a, b) => { for (let c = 0; b > c; c += 2)a.push(c); return a }),
        odd: ob((a, b) => { for (let c = 1; b > c; c += 2)a.push(c); return a }),
        lt: ob((a, b, c) => { for (let d = c < 0 ? c + b : c; --d >= 0;)a.push(d); return a }),
        gt: ob((a, b, c) => { for (let d = c < 0 ? c + b : c; ++d < b;)a.push(d); return a }),
      },
    }, d.pseudos.nth = d.pseudos.eq; for (b in {
      radio: !0, checkbox: !0, file: !0, password: !0, image: !0,
    })d.pseudos[b] = mb(b); for (b in { submit: !0, reset: !0 })d.pseudos[b] = nb(b); function qb() {}qb.prototype = d.filters = d.pseudos, d.setFilters = new qb(), g = gb.tokenize = function (a, b) {
      let c, e, f, g, h, i, j,
        k = z[`${a} `]; if (k) return b ? 0 : k.slice(0); h = a, i = [], j = d.preFilter; while (h) { (!c || (e = S.exec(h))) && (e && (h = h.slice(e[0].length) || h), i.push(f = [])), c = !1, (e = T.exec(h)) && (c = e.shift(), f.push({ value: c, type: e[0].replace(R, ' ') }), h = h.slice(c.length)); for (g in d.filter)!(e = X[g].exec(h)) || j[g] && !(e = j[g](e)) || (c = e.shift(), f.push({ value: c, type: g, matches: e }), h = h.slice(c.length)); if (!c) break } return b ? h.length : h ? gb.error(a) : z(a, i).slice(0)
    }; function rb(a) { for (var b = 0, c = a.length, d = ''; c > b; b++)d += a[b].value; return d } function sb(a, b, c) {
      const d = b.dir,
        e = c && d === 'parentNode',
      ...
      return d && !d[u] && (d = wb(d)), e && !e[u] && (e = wb(e, f)), ib((f, g, h, i) => {
        let j, k, l,
          ...
          r = c ? e || (f ? a : o || d) ? [] : g : q; if (c && c(q, r, h, i), d) { j = vb(r, n), d(j, [], h, i), k = j.length; while (k--)(l = j[k]) && (r[n[k]] = !(q[n[k]] = l)) } if (f) { if (e || a) { if (e) { j = [], k = r.length; while (k--)(l = r[k]) && j.push(q[k] = l); e(null, r = [], j, i) }k = r.length; while (k--)(l = r[k]) && (j = e ? J(f, l) : m[k]) > -1 && (f[j] = !(g[j] = l)) } } else r = vb(r === g ? r.splice(o, r.length) : r), e ? e(null, g, r, i) : H.apply(g, r)
      })
    } function xb(a) { for (var b, c, e, f = a.length, g = d.relative[a[0].type], h = g || d.relative[' '], i = g ? 1 : 0, k = sb(a => a === b, h, !0), l = sb(a => J(b, a) > -1, h, !0), m = [function (a, c, d) { const e = !g && (d || c !== j) || ((b = c).nodeType ? k(a, c, d) : l(a, c, d)); return b = null, e }]; f > i; i++) if (c = d.relative[a[i].type])m = [sb(tb(m), c)]; else { if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u]) { for (e = ++i; f > e; e++) if (d.relative[a[e].type]) break; return wb(i > 1 && tb(m), i > 1 && rb(a.slice(0, i - 1).concat({ value: a[i - 2].type === ' ' ? '*' : '' })).replace(R, '$1'), c, e > i && xb(a.slice(i, e)), f > e && xb(a = a.slice(e)), f > e && rb(a)) }m.push(c) } return tb(m) } function yb(a, b) {
      const c = b.length > 0,
        e = a.length > 0,
        f = function (f, g, h, i, k) {
          let l, m, o,
            ...
            x = u.length; for (k && (j = g !== n && g); q !== x && (l = u[q]) != null; q++) { if (e && l) { m = 0; while (o = a[m++]) if (o(l, g, h)) { i.push(l); break }k && (w = v) }c && ((l = !o && l) && p--, f && r.push(l)) } if (p += q, c && q !== p) { m = 0; while (o = b[m++])o(r, s, g, h); if (f) { if (p > 0) while (q--)r[q] || s[q] || (s[q] = F.call(i)); s = vb(s) }H.apply(i, s), k && !f && s.length > 0 && p + b.length > 1 && gb.uniqueSort(i) } return k && (w = v, j = t), r
        }; return c ? ib(f) : f
    } return h = gb.compile = function (a, b) {
      let c,
        d = [],
        e = [],
        f = A[`${a} `]; if (!f) { b || (b = g(a)), c = b.length; while (c--)f = xb(b[c]), f[u] ? d.push(f) : e.push(f); f = A(a, yb(e, d)), f.selector = a } return f
    ...
    sibling(a, b) { for (var c = []; a; a = a.nextSibling)a.nodeType === 1 && a !== b && c.push(a); return c },
  }), m.fn.extend({
    has(a) {
      let b,
        c = m(a, this),
    ...
    closest(a, b) { for (var c, d = 0, e = this.length, f = [], g = t.test(a) || typeof a !== 'string' ? m(a, b || this.context) : 0; e > d; d++) for (c = this[d]; c && c !== b; c = c.parentNode) if (c.nodeType < 11 && (g ? g.index(c) > -1 : c.nodeType === 1 && m.find.matchesSelector(c, a))) { f.push(c); break } return this.pushStack(f.length > 1 ? m.unique(f) : f) },
    index(a) { return a ? typeof a === 'string' ? m.inArray(this[0], m(a)) : m.inArray(a.jquery ? a[0] : a, this) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1 },
    add(a, b) { return this.pushStack(m.unique(m.merge(this.get(), m(a, b)))) },
  ...
  }, (a, b) => { m.fn[a] = function (c, d) { let e = m.map(this, b, c); return a.slice(-5) !== 'Until' && (d = c), d && typeof d === 'string' && (e = m.filter(d, e)), this.length > 1 && (C[a] || (e = m.unique(e)), B.test(a) && (e = e.reverse())), this.pushStack(e) } }); const E = /\S+/g,
    F = {}; function G(a) { const b = F[a] = {}; return m.each(a.match(E) || [], (a, c) => { b[c] = !0 }), b }m.Callbacks = function (a) {
    a = typeof a === 'string' ? F[a] || G(a) : m.extend({}, a); var b, c, d, e, f, g,
      h = [],
      i = !a.once && [],
    ...
    Deferred(a) {
      var b = [['resolve', 'done', m.Callbacks('once memory'), 'resolved'], ['reject', 'fail', m.Callbacks('once memory'), 'rejected'], ['notify', 'progress', m.Callbacks('memory')]],
        ...
        e = {}; return d.pipe = d.then, m.each(b, (a, f) => {
        const g = f[2],
    ...
    when(a) {
      let b = 0,
        ...
        i, j, k; if (e > 1) for (i = new Array(e), j = new Array(e), k = new Array(e); e > b; b++)c[b] && m.isFunction(c[b].promise) ? c[b].promise().done(h(b, k, c)).fail(g.reject).progress(h(b, j, i)) : --f; return f || g.resolveWith(k, c), g.promise()
    },
    ...
    L; for (L in m(k)) break; k.ownLast = L !== '0', k.inlineBlockNeedsLayout = !1, m(() => { let a, b, c, d; c = y.getElementsByTagName('body')[0], c && c.style && (b = y.createElement('div'), d = y.createElement('div'), d.style.cssText = 'position:absolute;border:0;width:0;height:0;top:0;left:-9999px', c.appendChild(d).appendChild(b), typeof b.style.zoom !== K && (b.style.cssText = 'display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1', k.inlineBlockNeedsLayout = a = b.offsetWidth === 3, a && (c.style.zoom = 1)), c.removeChild(d)) }), (function () { let a = y.createElement('div'); if (k.deleteExpando == null) { k.deleteExpando = !0; try { delete a.test } catch (b) { k.deleteExpando = !1 } }a = null }()), m.acceptData = function (a) {
    const b = m.noData[(`${a.nodeName} `).toLowerCase()],
      c = +a.nodeType || 1; return c !== 1 && c !== 9 ? !1 : !b || b !== !0 && a.getAttribute('classid') === b
  }; const M = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
    N = /([A-Z])/g; function O(a, b, c) { if (void 0 === c && a.nodeType === 1) { const d = `data-${b.replace(N, '-$1').toLowerCase()}`; if (c = a.getAttribute(d), typeof c === 'string') { try { c = c === 'true' ? !0 : c === 'false' ? !1 : c === 'null' ? null : `${+c}` === c ? +c : M.test(c) ? m.parseJSON(c) : c } catch (e) {}m.data(a, b, c) } else c = void 0 } return c } function P(a) {
    ...
    removeData(a) { return this.each(function () { m.removeData(this, a) }) },
  }), m.extend({
    queue(a, b, c) { let d; return a ? (b = `${b || 'fx'}queue`, d = m._data(a, b), c && (!d || m.isArray(c) ? d = m._data(a, b, m.makeArray(c)) : d.push(c)), d || []) : void 0 },
    dequeue(a, b) {
    ...
    _queueHooks(a, b) { const c = `${b}queueHooks`; return m._data(a, c) || m._data(a, c, { empty: m.Callbacks('once memory').add(() => { m._removeData(a, `${b}queue`), m._removeData(a, c) }) }) },
  }), m.fn.extend({
    queue(a, b) { let c = 2; return typeof a !== 'string' && (b = a, a = 'fx', c--), arguments.length < c ? m.queue(this[0], a) : void 0 === b ? this : this.each(function () { const c = m.queue(this, a, b); m._queueHooks(this, a), a === 'fx' && c[0] !== 'inprogress' && m.dequeue(this, a) }) },
    dequeue(a) { return this.each(function () { m.dequeue(this, a) }) },
    ...
    _ = /^([^.]*)(?:\.(.+)|)$/; function ab() { return !0 } function bb() { return !1 } function cb() { try { return y.activeElement } catch (a) {} }m.event = {
    global: {},
    add(a, b, c, d, e) {
      let f, g, h, i, j, k, l, n, o, p, q,
        r = m._data(a); if (r) {
    ...
    fix(a) {
      if (a[m.expando]) return a; let b, c, d,
        e = a.type,
        f = a,
    ...
    setup() {
      return m.nodeName(this, 'form') ? !1 : void m.event.add(this, 'click._submit keypress._submit', (a) => {
        const b = a.target,
          c = m.nodeName(b, 'input') || m.nodeName(b, 'button') ? b.form : void 0; c && !m._data(c, 'submitBubbles') && (m.event.add(c, 'submit._submit', (a) => { a._submit_bubble = !0 }), m._data(c, 'submitBubbles', !0))
      })
    },
    postDispatch(a) { a._submit_bubble && (delete a._submit_bubble, this.parentNode && !a.isTrigger && m.event.simulate('submit', this.parentNode, a, !0)) },
    teardown() { return m.nodeName(this, 'form') ? !1 : void m.event.remove(this, '._submit') },
    ...
    const c = function (a) { m.event.simulate(b, a.target, m.event.fix(a), !0) }; m.event.special[b] = {
      setup() {
    ...
    on(a, b, c, d, e) { let f, g; if (typeof a === 'object') { typeof b !== 'string' && (c = c || b, b = void 0); for (f in a) this.on(f, b, c, a[f], e); return this } if (c == null && d == null ? (d = b, c = b = void 0) : d == null && (typeof b === 'string' ? (d = c, c = void 0) : (d = c, c = b, b = void 0)), d === !1)d = bb; else if (!d) return this; return e === 1 && (g = d, d = function (a) { return m().off(a), g.apply(this, arguments) }, d.guid = g.guid || (g.guid = m.guid++)), this.each(function () { m.event.add(this, a, d, c, b) }) }, one(a, b, c, d) { return this.on(a, b, c, d, 1) }, off(a, b, c) { let d, e; if (a && a.preventDefault && a.handleObj) return d = a.handleObj, m(a.delegateTarget).off(d.namespace ? `${d.origType}.${d.namespace}` : d.origType, d.selector, d.handler), this; if (typeof a === 'object') { for (e in a) this.off(e, b, a[e]); return this } return (b === !1 || typeof b === 'function') && (c = b, b = void 0), c === !1 && (c = bb), this.each(function () { m.event.remove(this, a, c, b) }) }, trigger(a, b) { return this.each(function () { m.event.trigger(a, b, this) }) }, triggerHandler(a, b) { const c = this[0]; return c ? m.event.trigger(a, b, c, !0) : void 0 },
  }); function db(a) {
    const b = eb.split('|'),
    ...
    buildFragment(a, b, c, d) { for (var e, f, g, h, i, j, l, n = a.length, o = db(b), p = [], q = 0; n > q; q++) if (f = a[q], f || f === 0) if (m.type(f) === 'object')m.merge(p, f.nodeType ? [f] : f); else if (lb.test(f)) { h = h || o.appendChild(b.createElement('div')), i = (jb.exec(f) || ['', ''])[1].toLowerCase(), l = rb[i] || rb._default, h.innerHTML = l[1] + f.replace(ib, '<$1></$2>') + l[2], e = l[0]; while (e--)h = h.lastChild; if (!k.leadingWhitespace && hb.test(f) && p.push(b.createTextNode(hb.exec(f)[0])), !k.tbody) { f = i !== 'table' || kb.test(f) ? l[1] !== '<table>' || kb.test(f) ? 0 : h : h.firstChild, e = f && f.childNodes.length; while (e--)m.nodeName(j = f.childNodes[e], 'tbody') && !j.childNodes.length && f.removeChild(j) }m.merge(p, h.childNodes), h.textContent = ''; while (h.firstChild)h.removeChild(h.firstChild); h = o.lastChild } else p.push(b.createTextNode(f)); h && o.removeChild(h), k.appendChecked || m.grep(ub(p, 'input'), vb), q = 0; while (f = p[q++]) if ((!d || m.inArray(f, d) === -1) && (g = m.contains(f.ownerDocument, f), h = ub(o.appendChild(f), 'script'), g && zb(h), c)) { e = 0; while (f = h[e++])ob.test(f.type || '') && c.push(f) } return h = null, o },
    cleanData(a, b) { for (var d, e, f, g, h = 0, i = m.expando, j = m.cache, l = k.deleteExpando, n = m.event.special; (d = a[h]) != null; h++) if ((b || m.acceptData(d)) && (f = d[i], g = f && j[f])) { if (g.events) for (e in g.events)n[e] ? m.event.remove(d, e) : m.removeEvent(d, e, g.handle); j[f] && (delete j[f], l ? delete d[i] : typeof d.removeAttribute !== K ? d.removeAttribute(i) : d[i] = null, c.push(f)) } },
  }), m.fn.extend({
    text(a) { return V(this, function (a) { return void 0 === a ? m.text(this) : this.empty().append((this[0] && this[0].ownerDocument || y).createTextNode(a)) }, null, a, arguments.length) },
    append() { return this.domManip(arguments, function (a) { if (this.nodeType === 1 || this.nodeType === 11 || this.nodeType === 9) { const b = wb(this, a); b.appendChild(a) } }) },
    prepend() { return this.domManip(arguments, function (a) { if (this.nodeType === 1 || this.nodeType === 11 || this.nodeType === 9) { const b = wb(this, a); b.insertBefore(a, b.firstChild) } }) },
    ...
    remove(a, b) { for (var c, d = a ? m.filter(a, this) : this, e = 0; (c = d[e]) != null; e++)b || c.nodeType !== 1 || m.cleanData(ub(c)), c.parentNode && (b && m.contains(c.ownerDocument, c) && zb(ub(c, 'script')), c.parentNode.removeChild(c)); return this },
    empty() { for (var a, b = 0; (a = this[b]) != null; b++) { a.nodeType === 1 && m.cleanData(ub(a, !1)); while (a.firstChild)a.removeChild(a.firstChild); a.options && m.nodeName(a, 'select') && (a.options.length = 0) } return this },
    clone(a, b) { return a = a == null ? !1 : a, b = b == null ? a : b, this.map(function () { return m.clone(this, a, b) }) },
    html(a) {
    ...
    replaceWith() { let a = arguments[0]; return this.domManip(arguments, function (b) { a = this.parentNode, m.cleanData(ub(this)), a && a.replaceChild(b, this) }), a && (a.length || a.nodeType) ? this : this.remove() },
    detach(a) { return this.remove(a, !0) },
    domManip(a, b) {
      a = e.apply([], a); let c, d, f, g, h, i,
        j = 0,
        l = this.length,
        n = this,
        o = l - 1,
  ...
  }, (a, b) => { m.fn[a] = function (a) { for (var c, d = 0, e = [], g = m(a), h = g.length - 1; h >= d; d++)c = d === h ? this : this.clone(!0), m(g[d])[b](c), f.apply(e, c.get()); return this.pushStack(e) } }); let Cb,
    Db = {}; function Eb(b, c) {
    let d,
  ...
  }!(function () { let a; k.shrinkWrapBlocks = function () { if (a != null) return a; a = !1; let b, c, d; return c = y.getElementsByTagName('body')[0], c && c.style ? (b = y.createElement('div'), d = y.createElement('div'), d.style.cssText = 'position:absolute;border:0;width:0;height:0;top:0;left:-9999px', c.appendChild(d).appendChild(b), typeof b.style.zoom !== K && (b.style.cssText = '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1', b.appendChild(y.createElement('div')).style.width = '5px', a = b.offsetWidth !== 3), c.removeChild(d), a) : void 0 } }()); let Gb = /^margin/,
    Hb = new RegExp(`^(${S})(?!px)[a-z%]+$`, 'i'),
    Ib, Jb,
    Kb = /^(top|right|bottom|left)$/; a.getComputedStyle ? (Ib = function (b) { return b.ownerDocument.defaultView.opener ? b.ownerDocument.defaultView.getComputedStyle(b, null) : a.getComputedStyle(b, null) }, Jb = function (a, b, c) {
    let d, e, f, g,
    ...
    let b, c, d, e, f, g, h; if (b = y.createElement('div'), b.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", d = b.getElementsByTagName('a')[0], c = d && d.style) {
    ...
    cssHooks: { opacity: { get(a, b) { if (b) { const c = Jb(a, 'opacity'); return c === '' ? '1' : c } } } },
    cssNumber: {
  ...
  }), m.each(['height', 'width'], (a, b) => { m.cssHooks[b] = { get(a, c, d) { return c ? Ob.test(m.css(a, 'display')) && a.offsetWidth === 0 ? m.swap(a, Rb, () => Yb(a, b, d)) : Yb(a, b, d) : void 0 }, set(a, c, d) { const e = d && Ib(a); return Wb(a, c, d ? Xb(a, b, d, k.boxSizing && m.css(a, 'boxSizing', !1, e) === 'border-box', e) : 0) } } }), k.opacity || (m.cssHooks.opacity = {
    get(a, b) { return Nb.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || '') ? `${0.01 * parseFloat(RegExp.$1)}` : b ? '1' : '' },
    set(a, b) {
      const c = a.style,
        d = a.currentStyle,
  ...
  }), m.cssHooks.marginRight = Lb(k.reliableMarginRight, (a, b) => (b ? m.swap(a, { display: 'inline-block' }, Jb, [a, 'marginRight']) : void 0)), m.each({ margin: '', padding: '', border: 'Width' }, (a, b) => { m.cssHooks[a + b] = { expand(c) { for (var d = 0, e = {}, f = typeof c === 'string' ? c.split(' ') : [c]; d < 4; d++)e[a + T[d] + b] = f[d] || f[d - 2] || f[0]; return e } }, Gb.test(a) || (m.cssHooks[a + b].set = Wb) }), m.fn.extend({
    css(a, b) {
      return V(this, (a, b, c) => {
        let d, e,
          f = {},
    ...
    }; function fc() { return setTimeout(() => { $b = void 0 }), $b = m.now() } function gc(a, b) {
    let c,
      d = { height: a },
    ...
    var d, e,
      ...
      j = h.promise({
        ...
        duration: c.duration,
        tweens: [],
        createTween(b, c) { const d = m.Tween(a, j.opts, b, c, j.opts.specialEasing[b] || j.opts.easing); return j.tweens.push(d), d },
        stop(b) {
          let c = 0,
  ...
  }), m.each(['toggle', 'show', 'hide'], (a, b) => { const c = m.fn[b]; m.fn[b] = function (a, d, e) { return a == null || typeof a === 'boolean' ? c.apply(this, arguments) : this.animate(gc(b, !0), a, d, e) } }), m.each({
    slideDown: gc('show'), slideUp: gc('hide'), slideToggle: gc('toggle'), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' },
  }, (a, b) => { m.fn[a] = function (a, c, d) { return this.animate(b, a, c, d) } }), m.timers = [], m.fx.tick = function () {
    let a,
      b = m.timers,
      c = 0; for ($b = m.now(); c < b.length; c++)a = b[c], a() || b[c] !== a || b.splice(c--, 1); b.length || m.fx.stop(), $b = void 0
  }, m.fx.timer = function (a) { m.timers.push(a), a() ? m.fx.start() : m.timers.pop() }, m.fx.interval = 13, m.fx.start = function () { _b || (_b = setInterval(m.fx.tick, m.fx.interval)) }, m.fx.stop = function () { clearInterval(_b), _b = null }, m.fx.speeds = { slow: 600, fast: 200, _default: 400 }, m.fn.delay = function (a, b) { return a = m.fx ? m.fx.speeds[a] || a : a, b = b || 'fx', this.queue(b, (b, c) => { const d = setTimeout(b, a); c.stop = function () { clearTimeout(d) } }) }, (function () { let a, b, c, d, e; b = y.createElement('div'), b.setAttribute('className', 't'), b.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", d = b.getElementsByTagName('a')[0], c = y.createElement('select'), e = c.appendChild(y.createElement('option')), a = b.getElementsByTagName('input')[0], d.style.cssText = 'top:1px', k.getSetAttribute = b.className !== 't', k.style = /top/.test(d.getAttribute('style')), k.hrefNormalized = d.getAttribute('href') === '/a', k.checkOn = !!a.value, k.optSelected = e.selected, k.enctype = !!y.createElement('form').enctype, c.disabled = !0, k.optDisabled = !e.disabled, a = y.createElement('input'), a.setAttribute('value', ''), k.input = a.getAttribute('value') === '', a.value = 't', a.setAttribute('type', 'radio'), k.radioValue = a.value === 't' }()); const lc = /\r/g; m.fn.extend({
    val(a) {
      let b, c, d,
    ...
    valHooks: {
      option: { get(a) { const b = m.find.attr(a, 'value'); return b != null ? b : m.trim(m.text(a)) } },
      select: {
        get(a) { for (var b, c, d = a.options, e = a.selectedIndex, f = a.type === 'select-one' || e < 0, g = f ? null : [], h = f ? e + 1 : d.length, i = e < 0 ? h : f ? e : 0; h > i; i++) if (c = d[i], !(!c.selected && i !== e || (k.optDisabled ? c.disabled : c.getAttribute('disabled') !== null) || c.parentNode.disabled && m.nodeName(c.parentNode, 'optgroup'))) { if (b = m(c).val(), f) return b; g.push(b) } return g },
        set(a, b) {
          let c, d,
            e = a.options,
            f = m.makeArray(b),
  ...
  }), m.each(['radio', 'checkbox'], function () { m.valHooks[this] = { set(a, b) { return m.isArray(b) ? a.checked = m.inArray(m(a).val(), b) >= 0 : void 0 } }, k.checkOn || (m.valHooks[this].get = function (a) { return a.getAttribute('value') === null ? 'on' : a.value }) }); let mc, nc,
    oc = m.expr.attrHandle,
    pc = /^(?:checked|selected)$/i,
    qc = k.getSetAttribute,
    rc = k.input; m.fn.extend({ attr(a, b) { return V(this, m.attr, a, b, arguments.length > 1) }, removeAttr(a) { return this.each(function () { m.removeAttr(this, a) }) } }), m.extend({
    attr(a, b, c) {
      let d, e,
    ...
    attrHooks: { type: { set(a, b) { if (!k.radioValue && b === 'radio' && m.nodeName(a, 'input')) { const c = a.value; return a.setAttribute('type', b), c && (a.value = c), b } } } },
  }), nc = { set(a, b, c) { return b === !1 ? m.removeAttr(a, c) : rc && qc || !pc.test(c) ? a.setAttribute(!qc && m.propFix[c] || c, c) : a[m.camelCase(`default-${c}`)] = a[c] = !0, c } }, m.each(m.expr.match.bool.source.match(/\w+/g), (a, b) => { const c = oc[b] || m.find.attr; oc[b] = rc && qc || !pc.test(b) ? function (a, b, d) { let e, f; return d || (f = oc[b], oc[b] = e, e = c(a, b, d) != null ? b.toLowerCase() : null, oc[b] = f), e } : function (a, b, c) { return c ? void 0 : a[m.camelCase(`default-${b}`)] ? b.toLowerCase() : null } }), rc && qc || (m.attrHooks.value = { set(a, b, c) { return m.nodeName(a, 'input') ? void (a.defaultValue = b) : mc && mc.set(a, b, c) } }), qc || (mc = { set(a, b, c) { let d = a.getAttributeNode(c); return d || a.setAttributeNode(d = a.ownerDocument.createAttribute(c)), d.value = b += '', c === 'value' || b === a.getAttribute(c) ? b : void 0 } }, oc.id = oc.name = oc.coords = function (a, b, c) { let d; return c ? void 0 : (d = a.getAttributeNode(b)) && d.value !== '' ? d.value : null }, m.valHooks.button = { get(a, b) { const c = a.getAttributeNode(b); return c && c.specified ? c.value : void 0 }, set: mc.set }, m.attrHooks.contenteditable = { set(a, b, c) { mc.set(a, b === '' ? !1 : b, c) } }, m.each(['width', 'height'], (a, b) => { m.attrHooks[b] = { set(a, c) { return c === '' ? (a.setAttribute(b, 'auto'), c) : void 0 } } })), k.style || (m.attrHooks.style = { get(a) { return a.style.cssText || void 0 }, set(a, b) { return a.style.cssText = `${b}` } }); const sc = /^(?:input|select|textarea|button|object)$/i,
    tc = /^(?:a|area)$/i; m.fn.extend({ prop(a, b) { return V(this, m.prop, a, b, arguments.length > 1) }, removeProp(a) { return a = m.propFix[a] || a, this.each(function () { try { this[a] = void 0, delete this[a] } catch (b) {} }) } }), m.extend({
    ...
    propHooks: { tabIndex: { get(a) { const b = m.find.attr(a, 'tabindex'); return b ? parseInt(b, 10) : sc.test(a.nodeName) || tc.test(a.nodeName) && a.href ? 0 : -1 } } },
  }), k.hrefNormalized || m.each(['href', 'src'], (a, b) => { m.propHooks[b] = { get(a) { return a.getAttribute(b, 4) } } }), k.optSelected || (m.propHooks.selected = { get(a) { const b = a.parentNode; return b && (b.selectedIndex, b.parentNode && b.parentNode.selectedIndex), null } }), m.each(['tabIndex', 'readOnly', 'maxLength', 'cellSpacing', 'cellPadding', 'rowSpan', 'colSpan', 'useMap', 'frameBorder', 'contentEditable'], function () { m.propFix[this.toLowerCase()] = this }), k.enctype || (m.propFix.enctype = 'encoding'); const uc = /[\t\r\n\f]/g; m.fn.extend({
    addClass(a) {
      let b, c, d, e, f, g,
        h = 0,
        i = this.length,
    ...
    hasClass(a) { for (let b = ` ${a} `, c = 0, d = this.length; d > c; c++) if (this[c].nodeType === 1 && (` ${this[c].className} `).replace(uc, ' ').indexOf(b) >= 0) return !0; return !1 },
    ...
    if (a.JSON && a.JSON.parse) return a.JSON.parse(`${b}`); let c,
      d = null,
      e = m.trim(`${b}`); return e && !m.trim(e.replace(xc, (a, b, e, f) => c && b && (d = 0), d === 0 ? a : (c = e || b, d += !f - !e, ''))) ? Function(`return ${e}`)() : m.error(`Invalid JSON: ${b}`)
  }, m.parseXML = function (b) { let c, d; if (!b || typeof b !== 'string') return null; try { a.DOMParser ? (d = new DOMParser(), c = d.parseFromString(b, 'text/xml')) : (c = new ActiveXObject('Microsoft.XMLDOM'), c.async = 'false', c.loadXML(b)) } catch (e) { c = void 0 } return c && c.documentElement && !c.getElementsByTagName('parsererror').length || m.error(`Invalid XML: ${b}`), c }; let yc, zc,
    Ac = /#.*$/,
    Bc = /([?&])_=[^&]*/,
    Cc = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
    ...
    const e = {},
      f = a === Ic; function g(h) { let i; return e[h] = !0, m.each(a[h] || [], (a, h) => { const j = h(b, c, d); return typeof j !== 'string' || f || e[j] ? f ? !(i = j) : void 0 : (b.dataTypes.unshift(j), g(j), !1) }), i } return g(b.dataTypes[0]) || !e['*'] && g('*')
  } function Nc(a, b) {
    let c, d,
    ...
    ajaxSetup(a, b) { return b ? Nc(Nc(a, m.ajaxSettings), b) : Nc(m.ajaxSettings, a) },
    ajaxPrefilter: Lc(Hc),
    ajaxTransport: Lc(Ic),
    ajax(a, b) {
      typeof a === 'object' && (b = a, a = void 0), b = b || {}; var c, d, e, f, g, h, i, j,
        k = m.ajaxSetup({}, b),
        l = k.context || k,
    ...
    wrapAll(a) { if (m.isFunction(a)) return this.each(function (b) { m(this).wrapAll(a.call(this, b)) }); if (this[0]) { const b = m(a, this[0].ownerDocument).eq(0).clone(!0); this[0].parentNode && b.insertBefore(this[0]), b.map(function () { let a = this; while (a.firstChild && a.firstChild.nodeType === 1)a = a.firstChild; return a }).append(this) } return this },
    wrapInner(a) {
    ...
    wrap(a) { const b = m.isFunction(a); return this.each(function (c) { m(this).wrapAll(b ? a.call(this, c) : a) }) },
    unwrap() { return this.parent().each(function () { m.nodeName(this, 'body') || m(this).replaceWith(this.childNodes) }).end() },
  }), m.expr.filters.hidden = function (a) { return a.offsetWidth <= 0 && a.offsetHeight <= 0 || !k.reliableHiddenOffsets() && (a.style && a.style.display || m.css(a, 'display')) === 'none' }, m.expr.filters.visible = function (a) { return !m.expr.filters.hidden(a) }; const Qc = /%20/g,
    Rc = /\[\]$/,
    Sc = /\r?\n/g,
    Tc = /^(?:submit|button|image|reset|file)$/i,
    Uc = /^(?:input|select|textarea|keygen)/i; function Vc(a, b, c, d) { let e; if (m.isArray(b))m.each(b, (b, e) => { c || Rc.test(a) ? d(a, e) : Vc(`${a}[${typeof e === 'object' ? b : ''}]`, e, c, d) }); else if (c || m.type(b) !== 'object')d(a, b); else for (e in b)Vc(`${a}[${e}]`, b[e], c, d) }m.param = function (a, b) {
    let c,
      d = [],
  ...
  }, m.fn.extend({ serialize() { return m.param(this.serializeArray()) }, serializeArray() { return this.map(function () { const a = m.prop(this, 'elements'); return a ? m.makeArray(a) : this }).filter(function () { const a = this.type; return this.name && !m(this).is(':disabled') && Uc.test(this.nodeName) && !Tc.test(a) && (this.checked || !W.test(a)) }).map(function (a, b) { const c = m(this).val(); return c == null ? null : m.isArray(c) ? m.map(c, a => ({ name: b.name, value: a.replace(Sc, '\r\n') })) : { name: b.name, value: c.replace(Sc, '\r\n') } }).get() } }), m.ajaxSettings.xhr = void 0 !== a.ActiveXObject ? function () { return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && Zc() || $c() } : Zc; let Wc = 0,
    Xc = {},
    Yc = m.ajaxSettings.xhr(); a.attachEvent && a.attachEvent('onunload', () => { for (const a in Xc)Xc[a](void 0, !0) }), k.cors = !!Yc && 'withCredentials' in Yc, Yc = k.ajax = !!Yc, Yc && m.ajaxTransport((a) => {
    if (!a.crossDomain || k.cors) {
      let b; return {
        send(c, d) {
          let e,
            f = a.xhr(),
            g = ++Wc; if (f.open(a.type, a.url, a.async, a.username, a.password), a.xhrFields) for (e in a.xhrFields)f[e] = a.xhrFields[e]; a.mimeType && f.overrideMimeType && f.overrideMimeType(a.mimeType), a.crossDomain || c['X-Requested-With'] || (c['X-Requested-With'] = 'XMLHttpRequest'); for (e in c) void 0 !== c[e] && f.setRequestHeader(e, `${c[e]}`); f.send(a.hasContent && a.data || null), b = function (c, e) { let h, i, j; if (b && (e || f.readyState === 4)) if (delete Xc[g], b = void 0, f.onreadystatechange = m.noop, e)f.readyState !== 4 && f.abort(); else { j = {}, h = f.status, typeof f.responseText === 'string' && (j.text = f.responseText); try { i = f.statusText } catch (k) { i = '' }h || !a.isLocal || a.crossDomain ? h === 1223 && (h = 204) : h = j.text ? 200 : 404 }j && d(h, i, j, f.getAllResponseHeaders()) }, a.async ? f.readyState === 4 ? setTimeout(b) : f.onreadystatechange = Xc[g] = b : b()
        },
        abort() { b && b(void 0, !0) },
      }
    }
  }); function Zc() { try { return new a.XMLHttpRequest() } catch (b) {} } function $c() { try { return new a.ActiveXObject('Microsoft.XMLHTTP') } catch (b) {} }m.ajaxSetup({ accepts: { script: 'text/javascript, application/javascript, application/ecmascript, application/x-ecmascript' }, contents: { script: /(?:java|ecma)script/ }, converters: { 'text script': function (a) { return m.globalEval(a), a } } }), m.ajaxPrefilter('script', (a) => { void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = 'GET', a.global = !1) }), m.ajaxTransport('script', (a) => {
    if (a.crossDomain) {
      let b,
    ...
    ad = /(=)\?(?=&|$)|\?\?/; m.ajaxSetup({ jsonp: 'callback', jsonpCallback() { const a = _c.pop() || `${m.expando}_${vc++}`; return this[a] = !0, a } }), m.ajaxPrefilter('json jsonp', (b, c, d) => {
    let e, f, g,
      h = b.jsonp !== !1 && (ad.test(b.url) ? 'url' : typeof b.data === 'string' && !(b.contentType || '').indexOf('application/x-www-form-urlencoded') && ad.test(b.data) && 'data'); return h || b.dataTypes[0] === 'jsonp' ? (e = b.jsonpCallback = m.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(ad, `$1${e}`) : b.jsonp !== !1 && (b.url += `${(wc.test(b.url) ? '&' : '?') + b.jsonp}=${e}`), b.converters['script json'] = function () { return g || m.error(`${e} was not called`), g[0] }, b.dataTypes[0] = 'json', f = a[e], a[e] = function () { g = arguments }, d.always(() => { a[e] = f, b[e] && (b.jsonpCallback = c.jsonpCallback, _c.push(e)), g && m.isFunction(f) && f(g[0]), g = f = void 0 }), 'script') : void 0
    ...
    if (typeof a !== 'string' && bd) return bd.apply(this, arguments); let d, e, f,
      g = this,
      h = a.indexOf(' '); return h >= 0 && (d = m.trim(a.slice(h, a.length)), a = a.slice(0, h)), m.isFunction(b) ? (c = b, b = void 0) : b && typeof b === 'object' && (f = 'POST'), g.length > 0 && m.ajax({
  ...
  }, m.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (a, b) => { m.fn[b] = function (a) { return this.on(b, a) } }), m.expr.filters.animated = function (a) { return m.grep(m.timers, b => a === b.elem).length }; const cd = a.document.documentElement; function dd(a) { return m.isWindow(a) ? a : a.nodeType === 9 ? a.defaultView || a.parentWindow : !1 }m.offset = {
    setOffset(a, b, c) {
      let d, e, f, g, h, i, j,
        k = m.css(a, 'position'),
        l = m(a),
    ...
    offset(a) {
      if (arguments.length) return void 0 === a ? this : this.each(function (b) { m.offset.setOffset(this, a, b) }); let b, c,
        d = { top: 0, left: 0 },
        e = this[0],
    ...
    offsetParent() { return this.map(function () { let a = this.offsetParent || cd; while (a && !m.nodeName(a, 'html') && m.css(a, 'position') === 'static')a = a.offsetParent; return a || cd }) },
  }), m.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (a, b) => { const c = /Y/.test(b); m.fn[a] = function (d) { return V(this, (a, d, e) => { const f = dd(a); return void 0 === e ? f ? b in f ? f[b] : f.document.documentElement[d] : a[d] : void (f ? f.scrollTo(c ? m(f).scrollLeft() : e, c ? e : m(f).scrollTop()) : a[d] = e) }, a, d, arguments.length, null) } }), m.each(['top', 'left'], (a, b) => { m.cssHooks[b] = Lb(k.pixelPosition, (a, c) => (c ? (c = Jb(a, b), Hb.test(c) ? `${m(a).position()[b]}px` : c) : void 0)) }), m.each({ Height: 'height', Width: 'width' }, (a, b) => {
    m.each({ padding: `inner${a}`, content: b, '': `outer${a}` }, (c, d) => {
      m.fn[d] = function (d, e) {
        const f = arguments.length && (c || typeof d !== 'boolean'),
          g = c || (d === !0 || e === !0 ? 'margin' : 'border'); return V(this, (b, c, d) => { let e; return m.isWindow(b) ? b.document.documentElement[`client${a}`] : b.nodeType === 9 ? (e = b.documentElement, Math.max(b.body[`scroll${a}`], e[`scroll${a}`], b.body[`offset${a}`], e[`offset${a}`], e[`client${a}`])) : void 0 === d ? m.css(b, c, g) : m.style(b, c, d, g) }, b, f ? d : void 0, f, null)
      }
    })
  }), m.fn.size = function () { return this.length }, m.fn.andSelf = m.fn.addBack, typeof define === 'function' && define.amd && define('jquery', [], () => m); const ed = a.jQuery,
